...
\begin{document}
	...
	\begin{gather}
		\dd r \to \vu{e}_r, \quad r \dd \phi \to \vu{e}_{\phi}, \quad \dd z \to \vu{e}_{z}, \\
		\grad{f} = \pdv{f}{r} \vu{e}_r + \frac{1}{r}\pdv{f}{\phi} \vu{e}_{\phi} + \pdv{f}{z} \vu{e}_z.
	\end{gather}
	...
	\begin{example}
		\begin{enumerate}
			...
			\begin{gather*}
				\dd[2]{s} = \dd[2]{r} + r^2 \dd[2]{\phi} + \dd{z}, \quad \det g = r^2, \\
				\dd{u} = \pdv{u}{r} \dd{r} + \pdv{u}{\phi} \dd{\phi} + \pdv{u}{z} \dd{z},
			\end{gather*}
			\begin{align*}
				\star \dd{u} &= \sqrt{r^2} \qty(\pdv{u}{r} \dd{\phi} \wedge \dd{z} + \frac{1}{r^2} \pdv{u}{\phi} \dd{z} \wedge \dd{r} + \pdv{u}{z} \dd{r} \wedge \dd{\phi}) \\
				&= r \pdv{u}{r} \dd{\phi} \wedge \dd{z} + \frac{1}{r} \pdv{u}{\phi} \dd{z} \wedge \dd{r} + r \pdv{u}{z} \dd{r} \wedge \dd{\phi}.
			\end{align*}
	...
	\begin{equation}
		\star \dd(a_j \dd{x^j}) = \frac{1}{\sqrt{\det g}} \eps_{ijk} \pdv{a_j}{x^i} g_{kk} \dd{x^k}.
	\end{equation}
